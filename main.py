...
def display_test_results(predictions):
    ...
    for i, (prediction, filename) in enumerate(
            zip(predictions, os.listdir('C:/Users/pylyp/PycharmProjects/pythonProject1/test'))):
        img_path = os.path.join('C:/Users/pylyp/PycharmProjects/pythonProject1/test', filename)
